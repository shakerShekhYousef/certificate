...
@section('content')
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable"
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" class="desktop">Title English</th>
                                            <th scope="col" class="desktop">Title Arabic</th>
    ...
    <div id="table-url" data-url="{{route('blogs_list')}}"></div>
    <!-- end main content-->
@section('custom-script')
    ...
    <!-- List js -->
    <script src="{{asset('assets/admin/js/pages/blog/list.js')}}"></script>
    <!-- Sweet Alerts js -->
    <script src="{{asset('assets/libs/sweetalert2/sweetalert2.min.js')}}"></script>
    <!-- Delete js -->
    <script src="{{asset('assets/admin/js/pages/blog/delete.js')}}"></script>
